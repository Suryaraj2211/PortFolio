      ...
      <div className="hero-container">
        <div className="hero-content">
          ...
          <div className="hero-buttons">
            ...
            <a href="/resume.pdf" download="SURYA_PM_Resume.pdf" type="application/pdf" target="_blank" rel="noopener noreferrer" className="btn-secondary flex items-center gap-2">
